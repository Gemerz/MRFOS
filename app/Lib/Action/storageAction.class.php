<?php
class storageAction extends oabaseAction {
	...
	public function index(){
		...
		foreach ($result as $arr) {
			$arr['status'] ='<i data-editid="'.$arr['id'].'" data-editype="single" data-editfield="status" data-toggle="AJAXedit" data-editurl="'.U('storage/ajax_edit').'" class="'.($arr['status'] == 0 ? 'icon-remove' : 'icon-ok').'" data-value="'.$arr['status'].'"></i>';
			$arr['mangers'] ='<a class="editing" data-id="'.$arr['id'].'" href="#editing" data-orgurl="'.U('storage/edit').'" data-url="'.U('storage/edit',array('id'=>$arr['id'])).'" data-toggle="modal">'.L('edit').'</a>
							  <a data-toggle="AJAXdelete" data-url="'.U('storage/delete',array('id'=>$arr['id'])).'" >'.L('del').'</a>
							';
		...
		$str  = "<tr id='node-\$id' \$p_node >
                ...
                <td>\$spacer<span data-toggle='AJAXedit' data-value='\$name' data-editype='word' data-editurl='".U('storage/ajax_edit')."' data-editfield='name' data-editid='\$id'>\$name</span></td>
                <td>\$status</td>
             	<td>\$mangers</td>
                </tr>";
		...
		$add_menu = array(
            ...
            'id' => 'storage_add',
		 	...
		 	'height'=>'350',
		 	'btn' =>'save',
			'getajax'=>U('storage/ajax_getchilds'),
